...
<%@ taglib uri='http://java.sun.com/jsp/jstl/core' prefix='c'%>
  ...
  <head>
	...
	<style>
	body{
     background: url(http://localhost:9999/ShoppingCartFrontEnd/Resources/Images/bill.jpg) no-repeat;
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-7">
            <div class="panel panel-default">
                <div class="panel-heading"> <strong class="">BILLING ADDRESS</strong>
				</div>
                    <div class="panel-body">
                    <form class="form-horizontal" role="form" action="${flowExecutionUrl}&_eventId=submitBillingAddress"  commandName="billingAddress" method="post">
                     ...
                     <div class="form-group">
                        ...
                        <div class="control-group">
                          <!-- Button -->
                            <div class="controls">
                                  <button class="btn btn-success">Proceed to Payment Method</button>
