                ...
                <div class="panel-heading"> <strong class="">REGISTRATION</strong>
                    ...
                    <form class="form-horizontal" role="form" action="${action}" method="post">
                     ...
                     <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="password" class="form-control" name="password" id="inputPassword3" placeholder="(should be min of 5 chars)" pattern=".{5,18}" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="password" class="form-control" name="passwordconfirm" id="inputPassword3" placeholder="Password(Confirm)" pattern=".{5,18}" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Contact</label><br><br>
                            <div class="col-sm-12">
                                <input type="tel" class="form-control" name="contact" id="inputEmail3" placeholder="Contact (format: xx-xxxxxxxxxx)" maxlength="13" pattern="^\d{2}-\d{10}$" required="">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Email</label><br><br>
                            <div class="col-sm-12">
...
<div class="col-md-0">
<div class ="img1">
<a title="Home" href="./index"><img alt="Home" src="<c:url value="/Resources/Images/home.png"/>" border=0></a>
</div>
